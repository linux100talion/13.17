...
#    Камера сама OpenHD не гонит (stream_openhd:=false). NN1/NN2 пока не
#    запускаются — стример отдаёт чистое видео, рамки появятся, когда нейросети
#    начнут публиковать /nn1/detections, /nn2/scene.
