#!/bin/bash
# Остановить SPOT GPU (Tesla T4) инстанс в зоне europe-west4-c.
#
# Парный к c_start.sh: гасит инстанс в СВОЕЙ зоне (boot-диск зонален и остаётся
...
# тем же c_start.sh (или ../02_power_manager.sh start с ZONE=europe-west4-c).
#
