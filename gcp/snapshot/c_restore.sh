#!/bin/bash
# Восстановить boot-диск dev-workspace-1317 в зоне europe-west4-c из снапшота.
#
...
# создания). Переопределить конкретным:  SNAPSHOT=<name> ./c_restore.sh
#
...
TARGET_ZONE="europe-west4-c"     # ← единственное, чем отличаются a/b/c_restore.sh
REPLACE="${REPLACE:-0}"
...
echo "   Поднять инстанс на нём: ../spot/c_start.sh (создаст инстанс в этой зоне)."
