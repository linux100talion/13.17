#!/bin/bash
# Восстановить boot-диск dev-workspace-1317 в зоне europe-west4-b из снапшота.
#
...
# создания). Переопределить конкретным:  SNAPSHOT=<name> ./b_restore.sh
#
...
TARGET_ZONE="europe-west4-b"     # ← единственное, чем отличаются a/b/c_restore.sh
REPLACE="${REPLACE:-0}"
...
echo "   Поднять инстанс на нём: ../spot/b_start.sh (создаст инстанс в этой зоне)."
