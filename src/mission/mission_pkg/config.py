...
class BootstrapConfig:
    ...
    ipm_wz_tau: float = 20.0         # постоянная времени оценки нуля ω_z, сек; 0 = не снимать.
                                     ...
                                     # Замер сдвига измерения по I1s1 (боковая, derot=+1):
                                     #   τ=0 (сырой гироскоп)  +0.09 м/с
                                     #   τ=5/10/20/40          −0.01 / −0.02 / −0.02 / −0.02
                                     # то есть при τ≥5 сдвиг возвращается к уровню канала БЕЗ
                                     # вычитания (−0.02) и от τ уже не зависит — плато, а не
                                     # подобранная точка. Взято 20 с: дальше от границы плато
                                     # и меньше съедает настоящий разворот.
                                     # ⚠️ ЧЕГО НЕ ВЫШЛО. Калибровка нуля НА ЗЕМЛЕ (там истинный
