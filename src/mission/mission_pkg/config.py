...
class BootstrapConfig:
    ...
    # Отправная точка: при a₁=0.0115 м/с²/PWM демпфер kp=200 даёт 200 PWM на 1 м/с, то
    # есть постоянную торможения ~0.43 с — заведомо в рабочей зоне и без упора в потолок
    # 150 PWM на типичных 0.5-1 м/с. Свипить отдельно.
    pitch_rate_kp: float = 200.0
