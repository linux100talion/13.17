...
# не лечится. Следующая ступень — остаточные ~2 м: станция-кипинг
# BS_ROLL_POS_KP=0.3 поверх ki (контрфакт gain_sim на τ_s 0.40: путь в конце
# 0.1 м при пике 0.40 — на τ_s 0.80 та же строка была неустойчива, 1.44).
