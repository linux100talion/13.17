...
# ── ГЕЙНЫ ДЕМПФЕРА: kp 30 → 90 (2026-08-27, шаг 1 лесенки 60→90→120) ─────────
# ⚠️ ki НЕ ТРОГАТЬ, и это не небрежность. ki по ошибке СКОРОСТИ — это СКРЫТЫЙ
...
# (τ_s ≈ 0.55 с), ступень назад. Шаг 2, если 90 зайдёт: ki=0 + BS_ROLL_POS_KP=0.5
# (явный каскад вместо скрытого позиционного контура, ручки уже есть).
