...
# точки брейк не будит, порыв/отпущенный стик ≥0.5 м/с — будит. Полётом НЕ
# проверено — следующий прогон в 10 м/с сравнивать с ab_brake_v025 по паузе
# после стопа (было: возврат с 4-й с на 0.25 м/с, трим набран к 9-й с).
