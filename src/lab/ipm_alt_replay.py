...
⚠️ СТЕНД ГОНЯЕТ ЛЁТНЫЙ КОД: выпрямление, гейты и скорость считает настоящий
...
ЛЁТНЫМ `_ipm_px`), справа сам выпрямленный варп, тот самый, по которому считается LK.
