...
BS_ALT="${BS_ALT:-3}"
BS_HOLD_SEC="${BS_HOLD_SEC:-10}"      # держим уровень, sim-сек (окно yaw_check внутри него)
SAFE_SEC="${SAFE_SEC:-8}"             # окно оценки yaw_check от взлёта, sim-сек (< hold, не цепляет посадку)
