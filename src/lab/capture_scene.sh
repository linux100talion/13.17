...
while [ "$i" -lt "${#SEQ[@]}" ]; do
    ...
    docker exec \
      ...
      -e BS_YAW_TRANS_FIX="${BS_YAW_TRANS_FIX:-}" -e BS_ATT_EXTRAP="${BS_ATT_EXTRAP:-}" -e BS_IPM_MODEL="${BS_IPM_MODEL:-}" -e BS_KF_SEG_MIN="${BS_KF_SEG_MIN:-}" -e BS_KF_SEG_FRAC="${BS_KF_SEG_FRAC:-}" \
